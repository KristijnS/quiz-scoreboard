...
export const quizApi = {
    ...
    update: (id: number, data: { scaleConversionEnabled?: boolean; standardScale?: number; gradientEnabled?: boolean; exAequoEnabled?: boolean; exAequoValue?: number; lastRoundTiebreakerEnabled?: boolean }) =>
